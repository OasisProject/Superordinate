 ...
 * Beautiful!  This distro must look better than any other.  
 ...
 * Word Processor
 * Spreadsheets
 * Presentation Tool - BUT NOT A CONVENTIONAL ONE THAT ENCOURAGES STRUCTURED BULLSHITING!
...
#100% optional Cloud connections that provide conveinence AND respect a user's essential freedoms
...
When you Download Superordinate, you're downloading an image freshly made for you at a fair price, or compiling one yourself.  Let's see where this goes :).  For now, it's debian-based, but this could change as we move forward.  We're aiming to make this the most portable linux distro with a full GUI out there.  It can also be the most portable distro without a full GUI.  Yes, we are planning to release open hardware devices on which to run our decidedly superieor operating system, including:
